...
from access_connector import (import_product,
                              ...
                              get_image_for_pdf)
# custom PyQt6 widget imports
from show_image_form import Ui_Form
from report_form import TextBrowserWidget
...
class Ui_MainWindow(object):
    ...
    class Report_Generator():
        ...
        def get_product_data(self):
            ...
            rtf_report += "-------------------------------------------------------- \line"
            rtf_report += f"\line\line Ukupni iznos svih proizvoda iznosi: {sum_of_product} kn."
        ...
        def get_master_detail_data(self):
            master_detail_data = get_master_detail_data()
    ...
    def setupUi(self, MainWindow, selected_language, signed_user):
        ...
        """ button for reports """
        self.button_show_reports = QtWidgets.QPushButton(parent=self.centralwidget)
        self.button_show_reports.setGeometry(QtCore.QRect(340, 20, 131, 23))
        self.button_show_reports.setObjectName("button_show_reports")
        self.button_generate_reports = QtWidgets.QPushButton(parent=self.centralwidget)
        self.button_generate_reports.setGeometry(QtCore.QRect(340, 50, 131, 23))
        self.button_generate_reports.setObjectName("button_generate_reports")
        
        self.retranslateUi(MainWindow)
        
        # set opened tabs on add warehouse, and add product
